    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto py-12 px-6 lg:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div>
              <h2 className="text-4xl lg:text-5xl font-black tracking-tighter text-gray-900 uppercase mb-4">
                  Get in Touch
              </h2>
              ...
              <div className="space-y-8">
                  ...
                  <div className="flex items-center gap-6 p-6 rounded-2xl bg-gray-50 border border-gray-100">
                      ...
                      <div>
                          <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1">Phone Inquiry</p>
          ...
          <div className="bg-white rounded-[3rem] shadow-2xl shadow-gray-100 p-8 lg:p-12 border border-gray-100">
             ...
             <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <Button className="w-full h-14 rounded-xl uppercase tracking-widest text-xs font-black">
                   Send Inquiry
                </Button>
             </form>
          </div>
