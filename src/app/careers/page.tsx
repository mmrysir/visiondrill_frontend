  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white">
      <div className="max-w-5xl mx-auto py-12 px-6 lg:py-24">
        <Link href="/" className="inline-flex items-center text-xs font-black uppercase tracking-widest text-gray-400 hover:text-white transition-colors group mb-12">
        ...
        <div className="text-center mb-24">
            ...
            <h1 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter mb-6">Build the Future of <br/><span className="text-blue-500">Global Learning</span></h1>
        ...
        <div className="space-y-6">
            <h3 className="text-xl font-black uppercase tracking-widest text-gray-500 mb-8 border-b border-white/10 pb-4">Open Positions</h3>
                ...
                <div key={i} className="flex flex-col md:flex-row md:items-center justify-between p-8 rounded-[2rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-colors group">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center gap-3 mb-2">
                            <span className="text-[10px] font-black uppercase tracking-widest text-blue-400">{job.dept}</span>
                    ...
                    <Button className="h-12 px-8 rounded-xl font-black uppercase tracking-widest bg-white text-gray-900 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        Apply Now
                    </Button>
                </div>
            ))}
