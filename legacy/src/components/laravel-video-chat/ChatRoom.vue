            ...
            <div class="col-md-6">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <span class="glyphicon glyphicon-comment"></span> Chat with {{ withUser.fullname }}

                        <button class="btn btn-warning btn-sm pull-right" @click="startVideoCallToUser(withUser.id)" type="button">
                            <span class="fa fa-video-camera" title="Video Call"></span>
                        </button>
                    </div>
                    <div class="panel-body" style="width: 100% !important;">
                        <ul class="chat" v-chat-scroll>
                            ...
                            <span class="chat-img" v-bind:class="{ 'pull-right' : check(message.sender.id) , 'pull-left' : !check(message.sender.id) }">
                                <img :src="message.sender.picture" alt="User Avatar" class="img-circle" width="40" />
                            </span>
                                <div class="chat-body clearfix">
                                    <div class="header">
                                        <small class=" text-muted"><span class="glyphicon glyphicon-time"></span><timeago
